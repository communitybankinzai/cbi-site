...
const views={threeQuarter:[10,8,13],front:[18,1.7,0],side:[0,2,19],rear:[-18,2,0],top:[0,20,0.01],bottom:[-4,-12,10]};
...
try{const gltf=await new GLTFLoader().loadAsync('assets/tonbi/'+kind+'.glb?v=20260909-4');if(id!==request)return;
